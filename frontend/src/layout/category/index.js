...
//         <Typography variant="body2" color="textSecondary">
//         <LocationOn sx={{fontSize:"15px"}}  color="error" />
//         </Typography>
//       </Box>
      ...
      {isMobile ? (
        ...
        >
          ...
          <CardMedia
            ...
            image={Sales}  // Update with dynamic image URL if needed
            alt="Hotel"
          />
                        ...
                        <Grid item key={imgIndex}>
                          <img
                            ...
                            style={{
                              width: 150,
                              height: 150,
                              objectFit: 'cover', // Ensures proper scaling of the images
                            }}
                          />
                        </Grid>
                      ))}
                    ...
                    <Grid onClick={(e) => handleDetails(e, item._id)}>
                      <Box sx={{ display: 'flex', flexDirection: 'column', marginTop: '16px' }}>
                        <CardContent sx={{ paddingBottom: '8px' }}>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', marginTop: '8px' }}>
                            <Typography variant="body2" color="textSecondary">
                              <LocationOn color="error" sx={{ marginRight: '2px', fontSize: '15px' }} /> 

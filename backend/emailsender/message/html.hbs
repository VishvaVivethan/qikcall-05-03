const customerRegisterBody = (option) => {
  ...
  >
    ...
    <body style="word-spacing:normal;background-color:#f7f4cd;">
      <div style="background-color:#f7f4cd; padding-bottom:100px;">
        <table
          align="center"
          border="0"
          cellpadding="0"
          cellspacing="0"
          role="presentation"
          style="background-color:#f7f4cd;"
        >
          <tbody>
            <tr>
              <td>
  
                <div style="margin:30px auto;max-width:600px; height:100px">
                  <table
                    align="center"
                    border="0"
                    cellpadding="0"
                                        ...
                                        <tr>
                                          <td style="width:150px;">
                                           <img
                                            alt
                                            height="auto"
                                            src="https://res.cloudinary.com/qikcall/image/upload/v1725352887/qik-call-8.8_ar4air.png"
                                            style="border:0;display:block;outline:none;text-decoration:none;height:100px;width:100px;font-size:13px;padding-bottom:30px;"
                                            width="100px"
                                            height="100px"
                                          />
                                          </td>
        ...
        >
                        ...
                        <tr>
                          ...
                          >
                            ...
                            >
                              ...
                              <p>Verify your email address to complete the signup and login into your <strong>Qikcall</strong> account.
                              </p>
          ...
          <p style="margin-bottom:20px;">Click this link for active your account</p></p>
                               ...
                               <a href=${process.env.STORE_URL}/usersdetails?token=${option.token} style="background:#2d2859;color:white;border:1px solid #2d2859; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verify Account</a>
  
                              <p style="margin-top: 35px;">If you did not initiate
                                this request, please contact us immediately at
                                support@Qikcall.com</p>
